...
1. Allow the "human" access level permission to use the data download API for a 3-month grace period. The Data Portal will immediately redirect users to the login page if they only meet the “human” access level, satisfying most data publishers requiring "authenticated" access.
